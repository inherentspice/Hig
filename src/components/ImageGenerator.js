...
function getColors(props) {
  ...
  const depressingVal = props.depressing===maxVoted ? (props.depressing * 27) % 255: 0
  const alrightVal = props.alright===maxVoted ? (props.alright * 23) % 255: 0
  const beautifulVal = props.beautiful===maxVoted ? (props.beautiful * 52) % 255: 0
